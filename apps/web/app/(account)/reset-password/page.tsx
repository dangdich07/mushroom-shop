      ...
      <main className="flex min-h-[60vh] items-center justify-center px-4">
        <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-sm ring-1 ring-stone-100 text-center space-y-4">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center rounded-full bg-stone-900 px-4 py-2 text-sm font-semibold text-white hover:bg-black"
          >
            Yêu cầu lại
          </Link>
        </div>
        ...
        <form onSubmit={onSubmit} className="mt-6 space-y-4">
          <div>
            ...
            <input
              ...
              minLength={6}
              required
              className="mt-1 w-full rounded-2xl border border-stone-200 px-3 py-2.5 text-sm outline-none
